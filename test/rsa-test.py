...
message = "This is a secret message for John!"
print(f"Original Text: {message}")

encrypted_message = RSAEncryption().encrypt(message, john_public_key)
print("Encrypted message:", encrypted_message)

decrypted_message = RSAEncryption().decrypt(encrypted_message, john_private_key)
